...
def run_test():
    ...
    acquisition_data = {
        "directAcquisitionID": 9999,
        "directAcquisitionName": "name",
        "directAcquisitionDescription": "description",
        "uniqueIdentificationCode": "DA34",
        "publicationDate": "2023-12-28T09:11:30+02:00",
        "finalizationDate": "2023-12-28T09:11:30+02:00",
        "cpvCode": {
            "id": 13027,
            "text": "Produse farmaceutice (Rev.2)",
            "localeKey": "33600000-6",
        },
    }
    ...
    items_data = [
        {
            ...
            "catalogItemDescription": "Test item 1",
            "itemMeasureUnit": "bucata",
            "itemQuantity": 10,
            "itemClosingPrice": 100.50,
            "cpvCode": {
                "id": 19036,
                "text": "Servicii de medicina muncii (Rev.2)",
                "localeKey": "85147000-1",
            },
        },
        {
            "catalogItemName": "Item 2",
            "catalogItemDescription": "Test item 2",
            "itemMeasureUnit": "kg",
            "itemQuantity": 5,
            "itemClosingPrice": 200.75,
            "cpvCode": {
                "id": 19036,
                "text": "Servicii de medicina muncii (Rev.2)",
                "localeKey": "85147000-1",
    ...
    updated_acquisition = AcquisitionService.update_acquisition(
        acquisition_with_items["acquisition_id"],
